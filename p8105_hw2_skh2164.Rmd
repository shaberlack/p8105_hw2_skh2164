...
count(amyloid_df)
```
There are 479 participants at baseline and 487 participants in the amyloid dataset. This means that there are some participants who are in one dataset but not the other.
...
The resulting dataset has `r count(fulldf)` participants.
